...
Because both +X+ and +Y+ are uppercase, they are exported from the struct.
Had they been +x+ and +y+, they would be unexported, and therefore only visible within the struct.
